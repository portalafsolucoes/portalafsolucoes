...
interface StandardPlanDetailPanelProps {
        ...
        <div className="p-4 border-b border-border">
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-2">
            <div>
              ...
              <p className={valueCls}>{plan.family?.code} - {plan.family?.name}</p>
            </div>
            <div>
              <span className={labelCls}>Tipo Modelo</span>
              <p className={valueCls}>{plan.familyModel?.name || 'Genérico'}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className={valueCls}>{plan.serviceType?.code} - {plan.serviceType?.name}</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-b border-border">
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-2">
            ...
            <div>
              ...
              <p className={valueCls}>{plan.maintenanceTime} {plan.timeUnit}</p>
            </div>
            <div>

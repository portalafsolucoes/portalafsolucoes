  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="full" title="">
      <div className="h-full flex flex-col bg-secondary">
        ...
        <div className="flex-shrink-0 px-8 py-4 bg-card border-b border-border">
        ...
        <div className="flex-1 overflow-y-auto py-6">
          <form onSubmit={handleSubmit} className="max-w-4xl mx-auto px-8 space-y-6">
            ...
            <div className="bg-card rounded-md border border-border overflow-hidden">
              ...
              <div className="p-4">
                <div className="grid grid-cols-12 gap-3">
                  ...
                  <div className="col-span-12 flex items-center gap-6 pt-2 border-t border-border mt-2">
            ...
            <div className="flex gap-3 justify-end pt-4 pb-2 border-t border-border bg-card sticky bottom-0">

...
export function AssetFamilyModal({ editingItem, onClose, onSaved, assetFamilyModels, onModelsChanged, inPage = false }: AssetFamilyModalProps) {
  ...
  const title = editingItem ? 'Editar Família de Bens' : 'Nova Família de Bens'

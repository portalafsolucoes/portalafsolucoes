...
export async function POST(
  ...
  try {
    ...
    await recordAudit({
      ...
      after: (updatedRequest ?? { ...maintenanceRequest, executionCompletedAt: new Date().toISOString(), afterPhotoUrl, executionNotes, executionData: executionData || null }) as Record<string, unknown>,

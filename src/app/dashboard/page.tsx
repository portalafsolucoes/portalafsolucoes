              ...
              <>
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  ...
                  <div className="bg-card rounded-[4px] ambient-shadow p-6 hover:shadow-md transition-shadow duration-200">
                    ...
                    <div className="text-3xl font-black text-gray-900 mb-3">{stats?.workOrders.total}</div>
                  ...
                  <div className="bg-card rounded-[4px] ambient-shadow p-6 hover:shadow-md transition-shadow duration-200">
                    ...
                    <div className="text-3xl font-black text-gray-900 mb-3">{stats?.assets.total}</div>
                    <div className="flex gap-3 text-xs">
                  ...
                  <div className="bg-card rounded-[4px] ambient-shadow p-6 hover:shadow-md transition-shadow duration-200">
                    ...
                    <div className="text-3xl font-black text-gray-900 mb-3">{stats?.requests.total}</div>

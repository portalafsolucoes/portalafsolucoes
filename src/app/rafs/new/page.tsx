    ...
    <AppLayout>
      <div className="px-4 py-4 sm:px-6 lg:px-8 lg:py-6">
        <div className="mb-6 pt-16 lg:pt-0">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Novo RAF</h1>
          <p className="mt-1 text-sm text-gray-600">Preencha os dados do Relatório de Análise de Falha</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-card rounded-xl shadow-sm border border-border p-6">
            ...
            <div className="space-y-4">
              {hypothesisTests.map((test, index) => (
                <div key={index} className="grid grid-cols-1 md:grid-cols-4 gap-3 p-4 bg-secondary rounded-lg">
                  <input
                    type="text"
                    ...
                    className="md:col-span-2 px-3 py-2 border border-input rounded-lg focus:ring-2 focus:ring-ring"
          ...
          <div className="bg-card rounded-xl shadow-sm border border-border p-6">
            ...
            <div className="space-y-4">
              {actionPlan.map((action, index) => (
                <div key={index} className="grid grid-cols-1 md:grid-cols-3 gap-3 p-4 bg-secondary rounded-lg">
                  <input
                    type="text"
                    value={action.what}
                    onChange={(e) => {
          ...
          {/* Botões */}
          <div className="flex gap-3 justify-end bg-card rounded-xl shadow-sm border border-border p-6">
            <Button
              type="button"
              variant="outline"
              onClick={() => router.back()}
